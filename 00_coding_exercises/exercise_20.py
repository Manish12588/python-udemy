...
The tracker calculates the total transaction amount per customer and awards loyalty points accordingly.
Some customers may also qualify for bonus points based on their total spending.
...
def process_transactions(transactions: list[int]) -> int:
    ...
    loyalty_points = loyalty_points + total // 100  # earn 1 point per 100
    return total


result = process_transactions([400, 700])
print(f"Result: {result}")
print(f"Loyalty point: {loyalty_points}")
